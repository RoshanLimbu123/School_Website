...
namespace CMS.Core.Migrations
{
    ...
    [Migration("20201218083149_commerces")]
    partial class commerces
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CMS.Core.Entity.Commerce", b =>
                {
                    b.Property<long>("commerce_id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("CMS.Core.Entity.Specialities", b =>
                {
                    b.Property<long>("specialities_id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<long>("specialities_category_id");

                    b.Property<string>("title")
                        .IsRequired()
                        .HasMaxLength(50);

                    b.HasKey("specialities_id");

                    b.HasIndex("specialities_category_id");
            ...
            modelBuilder.Entity("CMS.Core.Entity.SpecialitiesCategory", b =>
                {
                    ...
                    b.HasKey("specialities_category_id");

                    b.ToTable("specialitiesCategories");
                });

            modelBuilder.Entity("CMS.Core.Entity.Teacher", b =>
                {
            ...
            modelBuilder.Entity("CMS.Core.Entity.Specialities", b =>
                {
                    b.HasOne("CMS.Core.Entity.SpecialitiesCategory", "specialities_category")
                        ...
                        .HasForeignKey("specialities_category_id")
                        .OnDelete(DeleteBehavior.Cascade);
                });
